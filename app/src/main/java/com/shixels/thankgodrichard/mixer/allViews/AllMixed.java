 ...
 */
public class AllMixed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<QBCustomObject> tempObjects =  helpers.fetchSavedCategories(getContext(),"mix");
        if( tempObjects == null){
            calldata(view);
        }
        else {
    ...
    private void calldata(final View view){
        helpers.fetchData(0,digitsSession,getContext(),0,"Recorded", new CallbackFuntion() {
            @Override
            ...
            public void gotdata(ArrayList<QBCustomObject> object) {
                ...
                if(object.size() == 0){
                    ...
                    helpers.saveCustomObject(object, getContext(), "mix");
                    setUpRecyclerView(view,object);
                }
