...
public class ShadowImageView extends AppCompatImageView {
    ...
    private static final String COLOR_STR = "#FF616161";
    ...
    /**
     * Instantiates a new Shadow image view.
     *
    ...
    private void init() {
        ...
        circle.getPaint().setColor(Color.parseColor(COLOR_STR));
    ...
    private class OvalShadow extends OvalShape {
        ...
        /**
         * Instantiates a new Oval shadow.
         *
